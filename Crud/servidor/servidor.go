...
func CriarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	//INSET INTO USUARIOS (nome, email) values("nome, "email")
	//PREPARE STATEMENT
...
func BuscarUsuarios(w http.ResponseWriter, r *http.Request) {
	...
	if erro != nil {
		w.Write([]byte("Erro ao buscar usuários no banc de dados!"))
		return
	}
	defer linhas.Close()
...
//BuscarUsuario busca por um usuário específico no banco de dados
...
//DeletarUsuario remove um susário do banco de dados
